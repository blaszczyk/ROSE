...
public class JavaEnumCreator {
	 ...
	 * create Enum
	 */
	public static void create(EnumModel enumModel, MetaData metadata) throws RoseException
	{
		String fullpath = metadata.getSrcpath() + metadata.getModelpackage().replaceAll("\\.", "/") + "/" + enumModel.getSimpleClassName() + ".java";

...
public class JavaRWModelCreator {
	...
	public static void create(Entity entity, MetaData metadata)
	{
		...
		try(Writer writer = new FileWriter(file))
		{
			...
			{
			case Writable:
				writeWritableMethods(entity, writer); //fallthrough
			case Readable:
				writeReadableMethods(entity, writer); //fallthrough
			case Entity:
			}
	...
	private static void writeReadableMethods(Entity entity, Writer writer) throws IOException
	{
	...
	private static void writeWritableMethods(Entity entity, Writer writer) throws IOException
	{			
			// setField
			int count = 0;
			...
			// setEntity
			count = 0;
			writer.write("\t@Override\n\tpublic void setEntity( int index, bn.blaszczyk.roseapp.model.Entity value )\n\t{\n" );
			writer.write("\t\tswitch( index )\n\t\t{\n");
			for(EntityField entityField : entity.getEntityFields())
			{
				if( !entityField.getType().isSecondMany() )
			...
			// addEntity()
			count = 0;
			writer.write("\t@Override\n\tpublic void addEntity( int index,  bn.blaszczyk.roseapp.model.Entity value )\n\t{\n" );
			...
			// removeEntity()
			count = 0;
			writer.write("\t@Override\n\tpublic void removeEntity( int index,  bn.blaszczyk.roseapp.model.Entity value )\n\t{\n" );
			writer.write("\t\tif( value == null )\n"
					+ "\t\t\treturn;\n"
					+ "\t\tswitch( index )\n\t\t{\n");
			for(EntityField entityField : entity.getEntityFields())
